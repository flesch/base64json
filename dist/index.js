(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("base64json", [], factory);
	else if(typeof exports === 'object')
		exports["base64json"] = factory();
	else
		root["base64json"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parse = exports.parse = function parse(text) {
	  var reviver = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];

	  return _json2.default.parse(_buffer.Buffer.from(text, 'base64').toString(), reviver);
	};
